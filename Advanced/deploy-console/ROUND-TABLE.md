# Round Table drive — first viewer (manager)

Called **Excalibur** before 2026-09-14 — "Excalibur" was reassigned that day
to mean the admin/designer's own elevated drive instead (see
[EXCALIBUR.md](EXCALIBUR.md)). Nothing about what this drive *is* changed,
only its name: the king wields Excalibur; everyone he hands a build to sits
at the Round Table.
...
[ROUND-TABLE_WALKTHROUGH.md](ROUND-TABLE_WALKTHROUGH.md). This page stays the
short checklist; that one is the teaching/reference version.

## What "Round Table" means here
...
3. USB or SSD, **32 GB or larger** for this stick (8 GB is the floor; give the first viewer room). `Zero-Touch-Deploy.ps1` refuses anything under the floor before it formats, since 2026-09-14.
